...
public class Evaluator implements BlockTexVisitor<StringBuilder, String> {
    ...
    @Override
    public String visit(Program p, StringBuilder errorLog) {
    ...
    public String visit(Statement s, StringBuilder errorLog) {
    ...
    // Credit: ChatGPT
    @Override
    public String visit(Condition c, StringBuilder errorLog, int i, int j, MatrixObject mo) {
    ...
    @Override
    public String visit(Conditional cl, StringBuilder errorLog, int i, int j, MatrixObject matrix) {
    ...
    @Override
    public String visit(EquationObject eo, StringBuilder stringBuilder) {
    ...
    @Override
    public String visit(LatexObject lo, StringBuilder errorLog) {
    ...
    @Override
    public String visit(FractionObject fo, StringBuilder errorLog) {
    ...
    @Override
    public String visit(SummationObject so, StringBuilder errorLog) {
    ...
    @Override
    public String visit(Loop loop, StringBuilder errorLog) {
    ...
    @Override
    public String visit(Block block, StringBuilder errorLog, int i, int j, MatrixObject matrix) {
    ...
    public String visit(SetLoopElement sle, StringBuilder errorLog, int i, int j, MatrixObject matrix) {
    ...
    @Override
    public String visit(ArithmeticExpression ae, StringBuilder errorLog) {
    ...
    @Override
    public String visit(DerivativeObject deo, StringBuilder sb) {
    ...
    @Override
    public String visit(IntegralObject io, StringBuilder sb) {
    ...
    @Override
    public String visit(UpdateMatrixElement um, StringBuilder errorLog) {
    ...
    @Override
    public String visit(MatrixObject mo, StringBuilder errorLog) {
    ...
    @Override
    public String visit(Name na, StringBuilder errorLog) {
        return latexMemory.get(na);
    }

    @Override
    public String visit(Number nu, StringBuilder errorLog) {
        return nu.toString();
    }

    @Override
    public String visit(Coordinate co, StringBuilder stringBuilder) {
        return null;
    }


    @Override
    public String visit(Expression ex, StringBuilder errorLog) {
    ...
    @Override
    public String visit(BlockStatement bs, StringBuilder stringBuilder, int row, int col, MatrixObject mo) {
